...
var __PRIVATE_IndexedDbLruDelegateImpl = class {
  ...
  Zn(e, t) {
    ...
    return n.J({
      ...
      0 === e2 ? (i !== __PRIVATE_ListenSequence.oe && t(new DocumentKey(__PRIVATE_decodeResourcePath(r2)), i), i = o, r2 = s) : i = __PRIVATE_ListenSequence.oe;
    }).next(() => {
...
var __PRIVATE_WebChannelConnection = class extends class __PRIVATE_RestConnection {
  ...
  xo(e, t, n) {
    ...
    void 0 !== a && (_.longPollingTimeout = Math.round(1e3 * a)), this.useFetchStreams && (_.xmlHttpFactory = new FetchXmlHttpFactory({})), this.vo(_.initMessageHeaders, t, n), _.encodeInitMessageHeaders = true;
    const u = i.join("");
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          void 0 === n3 && (n3 = C2.INTERNAL, i3 = "Unknown error status: " + t3 + " with message " + o2.message), h = true, P2.fo(new FirestoreError(n3, i3)), c.close();
        } else
...
async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
  ...
  const i = __PRIVATE_debugCast(e), { request: s, f_: o, parent: _ } = function __PRIVATE_toRunAggregationQueryRequest(e2, t2, n2) {
    ...
    return t2.he || (t2.he = __PRIVATE__queryToTarget(t2, e2.explicitOrderBy)), t2.he;
  }(t), n);
...
var __PRIVATE_RemoteStoreImpl = class {
  constructor(e, t, n, r2, i) {
    this.localStore = e, this.datastore = t, this.asyncQueue = n, this.remoteSyncer = {}, this.v_ = [], this.F_ = /* @__PURE__ */ new Map(), this.M_ = /* @__PURE__ */ new Set(), this.x_ = [], this.O_ = i, this.O_.ro((e2) => {
...
function __PRIVATE_remoteStoreUnlisten(e, t) {
  ...
  n.F_.delete(t), r2.Zo() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.F_.size && (r2.Zo() ? r2.t_() : __PRIVATE_canUseNetwork(n) && n.N_.set("Unknown"));
}
...
var __PRIVATE_SyncEngineImpl = class {
  constructor(e, t, n, r2, i, s) {
    this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r2, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.Sa = {}, this.ba = new ObjectMap((e2) => __PRIVATE_canonifyQuery(e2), __PRIVATE_queryEquals), this.Da = /* @__PURE__ */ new Map(), this.Ca = /* @__PURE__ */ new Set(), this.va = new SortedMap(DocumentKey.comparator), this.Fa = /* @__PURE__ */ new Map(), this.Ma = new __PRIVATE_ReferenceSet(), this.xa = {}, this.Oa = /* @__PURE__ */ new Map(), this.Na = __PRIVATE_TargetIdGenerator.Nn(), this.onlineState = "Unknown", this.La = void 0;
  }
  get isPrimaryClient() {
    return true === this.La;
  }
...
async function __PRIVATE_syncEngineListen(e, t, n = true) {
  ...
  let i;
  const s = r2.ba.get(t);
  return s ? (r2.sharedClientState.addLocalQueryTarget(s.targetId), i = s.view.ya()) : i = await __PRIVATE_allocateTargetAndMaybeListen(
    r2,
    t,
    n,
    true
...
async function __PRIVATE_triggerRemoteStoreUnlisten(e, t) {
  ...
  n.isPrimaryClient && 1 === i.length && (n.sharedClientState.removeLocalQueryTarget(r2.targetId), __PRIVATE_remoteStoreUnlisten(n.remoteStore, r2.targetId));
}
...
var __PRIVATE_ParseContextImpl = class {
  constructor(e, t, n, r2, i, s) {
    this.settings = e, this.databaseId = t, this.serializer = n, this.ignoreUndefinedProperties = r2, void 0 === i && this.mu(), this.fieldTransforms = i || [], this.fieldMask = s || [];
  }
  get path() {
