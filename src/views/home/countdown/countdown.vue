...
<script>
import "@/views/home/countdown/flip.scss";
import flip from "@/views/home/countdown/flip.vue";
...
export default {
  components: {
    flip,
    countdownFormDialog: defineAsyncComponent(() =>
      import("@/views/home/countdown/countdownFormDialog.vue")
    ),
  },
  computed: {
    ...mapGetters({
