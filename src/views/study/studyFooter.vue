...
export default {
  components: { book, caretLeft, caretRight,
    dict: defineAsyncComponent(() =>
      import("@/views/dict/dict.vue")
    ),
   },
  computed: {
    ...mapGetters({
